...
;(function($, window, document, undefined){
    ...
    var defaults = {
        ...
        // ,on_overlap_stop : function(collider_data){console.log("stop**********");}
    };
...
;(function($, window, document, undefined) {
    ...
    */
    fn.move_widget_up = function($widget, y_units) {
    	console.log("move widget up:"+$widget.attr('id'));
    ...
    */
    fn.move_widget_down = function($widget, y_units) {
    	console.log("move widget down:"+$widget.attr('id'));
    	// fix by Paul
    	//alert("h"); //supposed to fix drag n drop overlap on larger widget - doesnt work
    	//if (y_units <= 0){
        //    return;
    	//}
    	//
...
*/
    ...
    fn.resize_widget_dimensions = function(options) {
        ...
        if(this.options.widget_base_dimensions[0] > options.min_width){//paul
