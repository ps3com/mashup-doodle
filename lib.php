...
/**
 * This file contains main class for the course format mashup
 *
 * @since     2.0
 ...
 *
 * @package    format_mashup
 * @copyright  2012 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_mashup extends format_base {
    ...
    public function get_section_name($section) {
        ...
        if ((string)$section->name !== '') {
            ...
            return get_string('section0name', 'format_mashup');
        } else {
