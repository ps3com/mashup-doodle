<?php
require_once("{$CFG->dirroot}/course/format/mashup/classes/connectors/opensocial/util/BlobCrypter.php");
require_once("{$CFG->dirroot}/course/format/mashup/classes/connectors/opensocial/util/Crypto.php");
/*
...
class BasicBlobCrypter extends BlobCrypter {
  ...
  public function __construct() {
    ...
    //$this->allowPlaintextToken = Config::get('allow_plaintext_token');
  	$this->cipherKey = 'token_cipher_key';
  	$this->hmacKey = 'token_hmac_key';
  	$this->allowPlaintextToken = false;
  }
