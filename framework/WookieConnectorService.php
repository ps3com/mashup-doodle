...
require("{$CFG->dirroot}/course/format/mashup/framework/WookieConnectorExceptions.php");
require("{$CFG->dirroot}/course/format/mashup/framework/WookieServerConnection.php");
require("{$CFG->dirroot}/course/format/mashup/framework/WidgetInstances.php");
require_once("{$CFG->dirroot}/course/format/mashup/framework/Widgeta.php");
require("{$CFG->dirroot}/course/format/mashup/framework/WidgetInstance.php");
require("{$CFG->dirroot}/course/format/mashup/framework/WidgetProperties.php");
require("{$CFG->dirroot}/course/format/mashup/framework/User.php");
require("{$CFG->dirroot}/course/format/mashup/framework/HTTP_Response.php");
require("{$CFG->dirroot}/course/format/mashup/framework/Logger.php");
require("{$CFG->dirroot}/course/format/mashup/framework/WookieConnectorServiceInterface.php");
